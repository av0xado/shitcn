...
function getPortalRoot(): HTMLElement {
  let root = document.getElementById("control-panel-portal-root");
  if (!root) {
    root = document.createElement("div");
    root.id = "control-panel-portal-root";
    root.setAttribute("data-control-panel-root", "true");
...
export default function ControlPanel() {
  ...
  return (
    <div data-chaos-immune="true" style={{ zIndex: 99999 }}>
      ...
      {overlay ? createPortal(overlay, getPortalRoot()) : null}
    </div>
  );
}
